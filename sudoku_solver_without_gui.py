...
# Basic rules of Sudoku (shows why certain functions have a specific name) https://www.learn-sudoku.com/basic-techniques.html
...
input("Press Enter to solve the Sudoku\n")
...
print(board)
print("\n")
print("This Sudoku has been solved in %.2f seconds!" % total_time)